...
import { Sparkles, Users, BookOpen, Clock, GraduationCap, Filter, ArrowUpDown, CheckCircle2, Clock3, ArrowRight, Calendar, Video, User } from "lucide-react";
...
const Dashboard = () => {
  ...
  const { token, tokenData, studentDetails, setStudentDetails } =
    useAuth();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white lg:ml-72">
      ...
      {/* Navbar */}
      <nav className="bg-white border-b border-gray-100" style={{ boxShadow: '0 4px 6px -1px rgba(59, 130, 246, 0.3), 0 2px 4px -1px rgba(59, 130, 246, 0.2)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-3 min-h-[4rem]">
            <div className="flex items-center gap-4">
              {/* Icon Container with Gradient */}
              {/* <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-xl blur-md opacity-50"></div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto py-8 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          {/* 🔹 EVENT CALENDAR SECTION - Below All Batches (Dashboard View Only) */}
          {currentView === 'dashboard' && (
            <div className="mt-12">
              ...
              {loading ? (
                ...
                <div className="text-center py-16 px-4">
                  ...
                  <button
                    ...
                    className="group inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl shadow-lg hover:from-blue-700 hover:to-indigo-700 transform hover:scale-105 transition-all duration-300"
                  >
